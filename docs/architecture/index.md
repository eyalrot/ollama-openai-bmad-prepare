...
- [Ollama-to-OpenAI Proxy Service Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    - [Model: OllamaTagsResponse](./data-models.md#model-ollamatagsresponse)
    - [Model: OllamaGenerateRequest](./data-models.md#model-ollamageneraterequest)
    - [Model: OllamaChatRequest](./data-models.md#model-ollamachatrequest)
    - [Model: OllamaEmbeddingRequest](./data-models.md#model-ollamaembeddingrequest)
  - [Components](./components.md)
    - [API Gateway](./components.md#api-gateway)
    - [Request Router](./components.md#request-router)
    - [Request Translator](./components.md#request-translator)
    - [OpenAI Client Wrapper](./components.md#openai-client-wrapper)
    - [Response Translator](./components.md#response-translator)
  ...
  - [Next Steps](./next-steps.md)
    ...
    - [Specific Development Prompts:](./next-steps.md#specific-development-prompts)
